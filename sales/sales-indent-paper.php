                                                ...
                                                <div class="p-20">
                                                    <div class="col-sm-6 col-xs-6 col-md-6">
                                                        <div class="form-group">
                                                            <label for="productType">Customer Name: </label> Shakthi Papers
                                                        
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6 col-xs-6 col-md-6">
                                                        <div class="form-group">
                                                            <label for="productType">Purchase Order No:</label> <a href="view-po-paper.php">CPO10012</a>
