                                    ...
                                    <div class="row">
                                        <form action="#" data-parsley-validate novalidate>
                                            ...
                                            <div class="col-sm-12 col-xs-12 col-md-12">
                                                <div class="p-20">
                                                    <h4 class="header-title m-t-0 m-b-30">Godown Details</h4>
                                                    ...
                                                    <div class="col-sm-6 col-xs-6 col-md-6">
                                                        <div class="form-group">
                                                            <label for="consignee_name">Godown Type: </label> 
                                                    ...
                                                    <div class="col-sm-6 col-xs-6 col-md-6">
                                                        <div class="form-group">
                                                            <label for="tin">Godown Capcity: </label> 
                                                    ...
                                                    <div class="col-sm-6 col-xs-6 col-md-6">
                                                        <div class="form-group">
                                                            <label for="contact_no">Third Party Provider Name: </label> 
                                                            <input type="text" name="contact_no" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6 col-xs-6 col-md-6">
                                                        <div class="form-group">
                                                            <label for="email">Third Party Billing Details: </label> 
                                                    ...
                                                    <div class="col-sm-6 col-xs-6 col-md-6">
                                                        <div class="form-group">
                                                            <label for="email">Rent Charges: </label> 
                                                            <input type="text" name="email_id" class="form-control">
                                                        </div>
                                                    </div> 
